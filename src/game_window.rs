...
pub fn create_game_window(n: &str, w: u32, h: u32) -> GameWindow
{
    ...
    let _window = _video.window(n, w, h)
      .position_centered()
      .resizable()
      .opengl()
      .allow_highdpi()
    ...
    let _gl_context = _window.gl_create_context().expect("Couldn't create GL context");
    ...
    let _renderer = imgui_opengl_renderer::Renderer::new(&mut _imgui, |s| _video.gl_get_proc_address(s) as _);
